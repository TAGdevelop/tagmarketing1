<div class="d-flex justify-content-center mb-3 w-100 main_hours hours_alt1">
<?php if ( have_rows( 'hours_alt1', 'option' ) ) : ?>
<?php while ( have_rows( 'hours_alt1', 'option' ) ) : the_row(); ?>
