<?php
/**
 * tagFLEX Project admin functions.
 *
...
function hello_elementor_fail_load_admin_notice() {
	...
	if ( $is_elementor_installed ) {
		...
		$message = __( 'The tagFLEX Project child theme is a theme extension to the vanilla Hello Elementor theme, a lightweight starter theme designed to work perfectly with Elementor Page Builder plugin. The tagFLEX Project tightly builds in intrigrations with specific plugins used for digital marketing.', 'hello-elementor' );
	...
	<div class="notice updated is-dismissible hello-elementor-notice hello-elementor-install-elementor">
		<div class="hello-elementor-notice-inner">
			<div class="hello-elementor-notice-icon">
				<img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/tagflex-logo.png' ); ?>" alt="tagFLEX Logo" />
			</div>

			<div class="hello-elementor-notice-content">
				<h3><?php esc_html_e( 'Thanks for installing the tagFLEX Project child theme.', 'hello-elementor' ); ?></h3>
				<p>
					<p><?php echo esc_html( $message ); ?></p>
						<a href="https://tagdigitalmarketing.com/" target="_blank"><?php esc_html_e( 'Learn more about the tagFLEX Project', 'hello-elementor' ); ?></a>
