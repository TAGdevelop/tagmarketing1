        ...
        <div <?php if( in_array( 'saturate_more', get_field('image_effect') ) ) : ?>style="-webkit-filter: saturate(4);filter: saturate(4);"<?php endif; ?>>
          ...
          <div class="slideimgwrap">
           <?php $deskimage = get_field('image_desktop'); 
                  if( !empty($deskimage) ): ?>
            <img src="<?php echo $deskimage['url']; ?>" class="desktop img-responsive hidden-xs" <?php if( !empty($deskimage['alt']) ): ?> alt="<?php echo $deskimage['alt']; ?>" <?php else: ?> alt="<?php the_title(); ?>" <?php endif; ?>>
            <?php endif; ?>
         <?php $mobileimage = get_field('image_mobile');
          if( !empty($mobileimage) ): ?>
            <img src="<?php echo $mobileimage['url']; ?>" class="mobile img-responsive visible-xs" width="100%" <?php if( !empty($mobileimage['alt']) ): ?> alt="<?php echo $mobileimage['alt']; ?>" <?php else: ?> alt="<?php the_title(); ?>" <?php endif; ?>>
             <?php endif; ?>
              </div>
            <!-- Effects wrap close -->
              <?php if(get_field('effects_for_image') == '1' ): ?> 
...
<div <?php if (get_field('instagram_filters') != ''): ?>class="instagram-class <?=get_field('instagram_filters');?>"<?php endif; ?>>
  ...
  <?php if(get_field('effects_for_image') == '1' ): ?> 
        ...
        <div <?php if( in_array( 'saturate_more', get_field('image_effect') ) ) : ?>style="-webkit-filter: saturate(4);filter: saturate(4);"<?php endif; ?>>
            ...
            <!-- END Effects wrap open -->
          <div class="slideimgwrap">
                <img src="<?=$hgp_desk_img['url'];?>"<?php if( $hgp_desk_img['alt'] != ''): ?> alt="<?php echo $hgp_desk_img['alt']; ?>" <?php else: ?> alt="<?php echo $hgp_desk_img['title']; ?>" <?php endif; ?>class="desktop img-responsive hidden-xs">
                <img src="<?=$hgp_mob_img['url'];?>" <?php if( $hgp_mob_img['alt'] != ''): ?> alt="<?php echo $hgp_mob_img['alt']; ?>" <?php else: ?> alt="<?php echo $hgp_mob_img['title']; ?>" <?php endif; ?> class="mobile img-responsive visible-xs" >
                 </div>
            <!-- Effects wrap close -->
              <?php if(get_field('effects_for_image') == '1' ): ?> 
            </div>
